...
//  }
//  NSData *bufData = [NSData dataWithBytes:bufferData
//  length:sizeof(bufferData)];
//
...
//    XCTAssertEqualWithAccuracy(floatArray[baseIndex + 1], (float)i + 1,
//    0.0001); XCTAssertEqualWithAccuracy(floatArray[baseIndex + 2], (float)i +
//    2, 0.0001);
//  }
//}
//
